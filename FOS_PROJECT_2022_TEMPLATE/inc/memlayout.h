 ...
 *                     .Array of Avlb MemBlocks Elms  .
 *USER_DYN_BLKS_ARRAY->~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	08xxxxxxx
 *                     .                              .
 *                     .                              .
 *                     .                              .
 *                     |     Program Code & Data 	  |
...
//2022
#define USER_DYN_BLKS_ARRAY (ROUNDDOWN(USER_HEAP_START - (sizeof(struct MemBlock) * NUM_OF_UHEAP_PAGES), PAGE_SIZE) - PAGE_SIZE)
